            ...
            <Disclosure as="nav" className="bg-purple-900">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        <div className="sr-only flex items-center sm:hidden">
                            {/* Mobile menu button */}
                            <DisclosureButton
                                    ...
                                    {navigation.map((item) => (
                                        <Link
                                            ...
                                            className={classNames(
                                                pathname === item.href || pathname.startsWith(item.href + '/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
